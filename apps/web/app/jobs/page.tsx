...
export const metadata: Metadata = {
  ...
  description:
    "Paste your background. Granted breaks it into your distinctive strengths and finds companies in Canada, the US, the UK and Australia funded to do that work — including ones not advertising jobs.",
};
    ...
    <section className="mx-auto max-w-3xl">
      <header className="mb-8 text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-pretty text-[15px] leading-relaxed text-[var(--color-muted)]">
          Paste your background. We break it into your most distinctive strengths and find
